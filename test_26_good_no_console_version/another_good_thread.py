...
class Mywin_xx(wx.Frame):
   ...
   def InitUI(self):
      ...
      #hbox3.Add(wx.HORIZONTAL, proportion=5, flag=wx.ALIGN_CENTRE, border=10)
	  #hbox1.Add(self.gauge, proportion=5, flag=wx.ALIGN_CENTRE, border=10) , the good one
      pnl.SetSizer(vbox)
      self.Centre()
      self.Show(True)
...
class TestThread(Thread):
    #Test Worker Thread Class: Random thread concurrent update 
